...
@section('content')
            ...
            <table class="overflow-x-auto w-full bg-white" id="table">
                ...
                @foreach ($purchases as $purchase)
                    <tr class="bg-white font-medium text-sm divide-y divide-gray-200">
                        ...
                        <td class="p-4 whitespace-nowrap">{{ $purchase->category_id }}</td>
    ...
    <dialog id="nova_compra" class="p-5 bg-white rounded-md md:w-1/2 sm:w-full">
    ...
    <dialog id="edit{{ $purchase->id }}" class="p-5 bg-white rounded-md md:w-1/2 sm:w-full">
                ...
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
                    <div class="-mx-3 md:flex mb-6">
                        <div class="md:w-full px-3 mb-6 md:mb-0">
                            ...
                            <input
                                name="name"
                                class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3"
                                id="grid-name" value="{{$purchase->item}}" type="text" placeholder="Item">
                        </div>
                    </div>
                    <div class="-mx-3 md:flex mb-6">
                        <div class="md:w-full px-3">
                            ...
                            <input
                                name="vl_unit"
                                class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3"
                                id="grid-price" type="number" step="0.01" value="{{$purchase->unit_value}}"
                                placeholder="
                            Valor unitário">
                        </div>
                        <div class="md:w-full px-3">
                    ...
                    <div class="md:w-full px-3">
                        ...
                        <input
                            name="category_id"
                            class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4"
                            id="grid-category" type="text" value="{{$purchase->category_id}}" placeholder="Categoria">
                    </div>
                    <div class="-mx-3 md:flex mb-6">
                        <div class="md:w-full px-3 mb-6 md:mb-0">
                            <label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2"
                            ...
                            <input
                                name="provider"
                                class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3"
                                id="grid-provider" type="text" value="{{$purchase->provider}}" placeholder="Fornecedor">
                        </div>
                    </div>
                    <div class="md:w-full px-3">
                        <div class="bg-white p7 rounded w-9/12 mx-auto">
                            <div x-data="dataFileDnD()"
                                ...
                                <div x-ref="dnd"
                                    ...
                                    <input accept="*" type="file"
                                           ...
                                           @dragleave="$refs.dnd.classList.remove('border-blue-400'); $refs.dnd.classList.remove('ring-4'); $refs.dnd.classList.remove('ring-inset');"
                                           @drop="$refs.dnd.classList.remove('border-blue-400'); $refs.dnd.classList.remove('ring-4'); $refs.dnd.classList.remove('ring-inset');"
                                           title="" value="value="{{$purchase->invoice_path}}"/>
