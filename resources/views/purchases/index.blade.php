    ...
    <table class="overflow-x-auto w-full" id="table">
        <thead class="border-b border-gray-300">
            <tr>
                ...
                <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300">Item</th>
                <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300">Categoria</th>
                <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300">Valor unitário</th>
                <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300">Quantidade</th>
                <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300">Valor total</th>
                <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300">Fornecedor</th>
                <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300">Chave de
                    identificação
                </th>
                <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300">Nota Fiscal</th>
                <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300">Ações</th>
            </tr>
        </thead>
                ...
                <tr class="bg-white font-medium divide-y divide-gray-200">
                    ...
                    <td class="p-4 whitespace-nowrap">
                        <a href="{{route('downloadInvoice', ['id' => $purchase->id])}}"
                           class="text-dark-blue hover:underline">Nota Fiscal</a>
                    </td>
                    <td class="p-4 whitespace-nowrap">
                        <a class="text-dark-blue hover:underline"
