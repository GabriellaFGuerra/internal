    ...
    <div class="flex flex-wrap justify-items-center grid md:grid-cols-2 lg:grid-cols-3 gap-0">
        @if (Auth::user()->role_id == 1 or Auth::user()->role_id == 2)
            <div class="max-w-md py-4 px-8 bg-white shadow-lg rounded-lg my-5 md:my-10">
                ...
                <div class="flex justify-end mt-4">
                    <a href="{{route('purchases')}}" class="text-xl font-medium text-dark-blue">Acessar</a>
                </div>
            </div>
        @endif
        @if (Auth::user()->role_id != 4)
            <div class="max-w-md py-4 px-8 bg-white shadow-lg rounded-lg my-5 md:my-10">
                ...
                <div class="flex justify-end mt-4">
                    <a href="{{route('documents')}}" class="text-xl font-medium text-dark-blue">Acessar</a>
                </div>
            </div>
        @endif
        @if (Auth::user()->role_id != 3)
            <div class="max-w-md py-4 px-8 bg-white shadow-lg rounded-lg my-5 md:my-10">
                ...
                <div class="flex justify-end mt-4">
                    <a href="{{route('stock')}}" class="text-xl font-medium text-dark-blue">Acessar</a>
                </div>
            </div>
        @endif
        @if (Auth::user()->role_id != 4)
            <div class="max-w-md py-4 px-8 bg-white shadow-lg rounded-lg my-5 md:my-10">
                ...
                <div class="flex justify-end mt-4">
                    <a href="{{route('employees')}}" class="text-xl font-medium text-dark-blue">Acessar</a>
                </div>
            </div>
            <div class="max-w-md py-4 px-8 bg-white shadow-lg rounded-lg my-5 md:my-10">
                <div>
                ...
                <div class="flex justify-end mt-4">
                    <a href="{{route('blueprints')}}" class="text-xl font-medium text-dark-blue">Acessar</a>
                </div>
            </div>
            <div class="max-w-md py-4 px-8 bg-white shadow-lg rounded-lg my-5 md:my-10">
                <div>
                ...
                <div class="flex justify-end mt-4">
                    <a href="{{route('projects')}}" class="text-xl font-medium text-dark-blue">Acessar</a>
                </div>
            </div>
        @endif
    </div>
