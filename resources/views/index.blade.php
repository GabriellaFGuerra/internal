                ...
                <div class="px-5 py-7">
                    <form method="post" action="{{ route('login.auth') }}">
                        ...
                        <input type="email" name="email"
                            class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full @error('email') border-red-500 @enderror" />
                    ...
                    <div class="grid grid-cols-2 gap-1">
                        <div class="text-center sm:text-left whitespace-nowrap">
                            <a href="{{ route('forgotpassword') }}"
                                class="hover-text transition duration-200 mx-5 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 focus:outline-none">
