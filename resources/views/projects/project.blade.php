@extends('layout.index', ['title' => str_replace('_', ' ', ucfirst($slug))])

@section('content')
    <main class="px-3">
        <div class="text-4xl sm:text-5xl text-center my-10">{{str_replace('_', ' ', ucfirst($slug))}}</div>
            ...
            <div class="bg-white">
                <div class="px-10 py-2 mb-10 text-center">
                    <div class="text-2xl font-bold text-green-500 mb-4">Diário de obras
                        <button type="button"
                                onclick="document.getElementById('new_entry').showModal()"
                                class="focus:outline-none mt-0.5">
                    ...
                    <p>
                        <button class="uk-link focus:outline-none"
                                onclick="document.getElementById('diario_1').showModal()">00/00/0000 00:00
                        </button>
                    </p>
                </div>
            </div>
        ...
        <div class="w-full m-auto">
            <div class="px-5 pt-4 shadow-lg bg-white pb-6 pt-4 rounded-lg leading-normal overflow-auto">
                <table class="overflow-x-auto w-full bg-white" id="table">
                    ...
                    <tr class="bg-white font-medium text-sm divide-y divide-gray-200">
                        <td class="p-4 whitespace-nowrap">4</td>
                        <td class="p-4 whitespace-nowrap">Placeholder</td>
                        <td class="p-4 whitespace-nowrap">R$200,00</td>
                        <td class="p-4 whitespace-nowrap">1</td>
                        <td class="p-4 whitespace-nowrap">R$200,00</td>
                    ...
                    <tr class="bg-white font-medium text-sm divide-y divide-gray-200">
                        <td class="p-4 whitespace-nowrap">5</td>
                        <td class="p-4 whitespace-nowrap">Placeholder</td>
                        <td class="p-4 whitespace-nowrap">R$200,00</td>
                        <td class="p-4 whitespace-nowrap">1</td>
                        <td class="p-4 whitespace-nowrap">R$200,00</td>
    ...
    <dialog id="diario_1" class="p-5 bg-white rounded-md w-full">
        ...
        <div class="flex justify-end flex-row gap-4">
            <button
                onclick="document.getElementById('edit_diario_1').showModal(); document.getElementById('diario_1').close();"
                type="button"
    ...
    <dialog id="edit_diario_1" class="p-5 bg-white rounded-md w-full">
        <div class="flex flex-col">
            <div class="flex w-full h-auto justify-center items-center">
                <div class="flex w-10/12 h-auto py-3 justify-center items-center font-bold text-lg md:text-2xl">
                    00/00/0000 00:00
                </div>
                <div onclick="document.getElementById('edit_diario_1').close();"
                     class="flex w-1/12 h-auto justify-center cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                         stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                         class="feather feather-x">
            ...
            <div id="editor">Lorem ipsum dolor sit amet, consectetur adipis</div>
