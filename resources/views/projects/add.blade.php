        ...
        <div class="flex flex-col">
            ...
            <div class="-mx-3 md:flex mb-2">
                <div class="md:w-full px-3">
                    <label class="block uppercase tracking-wide text-white text-xs font-bold mb-2" for="grid-address">
                        Endereço
                    </label>
                    <input name="address"
                        class="border-2 border-gray-500 rounded-lg px-2 py-2 mt-1 mb-4 text-sm w-full text-gray-900"
            ...
            <div class="md:w-full px-3 mb-2 md:mb-0" id="grid-stage-dropdown">
                <label class="block uppercase tracking-wide text-white text-xs font-bold mb-2" for="grid-stage">
                    Etapa
                </label>
                <select name="stage"
                    class="border-2 border-gray-500 rounded-lg px-2 py-2 mt-1 mb-4 text-sm w-full text-gray-900"
            ...
            <div class="md:w-full px-3 mb-2 md:mb-0" id="grid-user-dropdown">
                <label class="block uppercase tracking-wide text-white text-xs font-bold mb-2" for="grid-user">
                    Responsável
                </label>
                <select name="user_id"
                    class="border-2 border-gray-500 rounded-lg px-2 py-2 mt-1 mb-4 text-sm w-full text-gray-900"
